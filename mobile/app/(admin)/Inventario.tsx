        ...
        <>
                        ...
                        <View key={insumo.id} style={style.card}>
                            <View style={style.cardHeader}>
                                ...
                                <View style={style.cardAcciones}>
                                    ...
                                    <TouchableOpacity style={style.btnEliminar} onPress={() => confirmarEliminacion(insumo.id)}>
                                        <Text style={style.btnEliminarText}>Eliminar</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
                            <View style={[style.ubicacionPill, insumo.ubicacion === 'ambulancia' ? style.pillAmbulancia : style.pillBodega]}>
                            ...
                            <View style={style.cardBody}>
                                ...
                                <View style={style.campo}>
                                    ...
                                    <Text style={[style.campoValor, insumo.stockTotal <= insumo.stockMinimo && { color: '#ef4444' }]}>
                                        {insumo.stockTotal} {insumo.unidadMedida}
                                    </Text>
                                </View>
                                <View style={style.campo}>
                                    <Text style={style.campoLabel}>Stock mínimo</Text>
                                    <Text style={style.campoValor}>{insumo.stockMinimo} {insumo.unidadMedida}</Text>
                                </View>
                            </View>
            ...
            <Modal visible={modalVisible} transparent animationType="slide">
                ...
                <View style={style.modal}>
                    ...
                    <TextInput style={style.input} value={stockTotal} onChangeText={setStockTotal} keyboardType="numeric" />
